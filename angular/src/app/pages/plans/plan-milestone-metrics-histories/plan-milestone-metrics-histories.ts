...
@Component({
  selector: 'app-plan-milestone-metrics-histories',
  imports: [CommonModule, DxChartModule],
  templateUrl: './plan-milestone-metrics-histories.html',
  styleUrl: './plan-milestone-metrics-histories.scss',
})
export class PlanMilestoneMetricsHistories {
