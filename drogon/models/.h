...
class 
{
  public:
     ...
     */
    explicit (const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit (const Json::Value &pJson) noexcept(false);
  ...
  private:
    ...
    friend drogon::orm::BaseBuilder<, true, true>;
    friend drogon::orm::BaseBuilder<, true, false>;
    friend drogon::orm::BaseBuilder<, false, true>;
    friend drogon::orm::BaseBuilder<, false, false>;
#ifdef __cpp_impl_coroutine
