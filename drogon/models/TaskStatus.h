...
class TaskStatus
{
  public:
     ...
     */
    explicit TaskStatus(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit TaskStatus(const Json::Value &pJson) noexcept(false);
     ...
     */
    TaskStatus(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<TaskStatus>;
    friend drogon::orm::BaseBuilder<TaskStatus, true, true>;
    friend drogon::orm::BaseBuilder<TaskStatus, true, false>;
    friend drogon::orm::BaseBuilder<TaskStatus, false, true>;
    friend drogon::orm::BaseBuilder<TaskStatus, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<TaskStatus>;
#endif
