...
class MentorsTasks
{
  public:
     ...
     */
    explicit MentorsTasks(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit MentorsTasks(const Json::Value &pJson) noexcept(false);
     ...
     */
    MentorsTasks(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    MentorsTasks() = default;
  ...
  private:
    friend drogon::orm::Mapper<MentorsTasks>;
    friend drogon::orm::BaseBuilder<MentorsTasks, true, true>;
    friend drogon::orm::BaseBuilder<MentorsTasks, true, false>;
    friend drogon::orm::BaseBuilder<MentorsTasks, false, true>;
    friend drogon::orm::BaseBuilder<MentorsTasks, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<MentorsTasks>;
#endif
