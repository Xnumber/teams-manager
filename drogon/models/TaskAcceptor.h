...
class TaskAcceptor
{
  public:
     ...
     */
    explicit TaskAcceptor(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit TaskAcceptor(const Json::Value &pJson) noexcept(false);
     ...
     */
    TaskAcceptor(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    TaskAcceptor() = default;
  ...
  private:
    friend drogon::orm::Mapper<TaskAcceptor>;
    friend drogon::orm::BaseBuilder<TaskAcceptor, true, true>;
    friend drogon::orm::BaseBuilder<TaskAcceptor, true, false>;
    friend drogon::orm::BaseBuilder<TaskAcceptor, false, true>;
    friend drogon::orm::BaseBuilder<TaskAcceptor, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<TaskAcceptor>;
#endif
