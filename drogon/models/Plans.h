...
class Plans
{
  public:
     ...
     */
    explicit Plans(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Plans(const Json::Value &pJson) noexcept(false);
     ...
     */
    Plans(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Plans>;
    friend drogon::orm::BaseBuilder<Plans, true, true>;
    friend drogon::orm::BaseBuilder<Plans, true, false>;
    friend drogon::orm::BaseBuilder<Plans, false, true>;
    friend drogon::orm::BaseBuilder<Plans, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Plans>;
#endif
