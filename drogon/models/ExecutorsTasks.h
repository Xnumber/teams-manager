...
class ExecutorsTasks
{
  public:
    ...
    using PrimaryKeyType = std::tuple<std::string,std::string>;//task_id,user_id
     ...
     */
    explicit ExecutorsTasks(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ExecutorsTasks(const Json::Value &pJson) noexcept(false);
     ...
     */
    ExecutorsTasks(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    ExecutorsTasks() = default;
  ...
  private:
    friend drogon::orm::Mapper<ExecutorsTasks>;
    friend drogon::orm::BaseBuilder<ExecutorsTasks, true, true>;
    friend drogon::orm::BaseBuilder<ExecutorsTasks, true, false>;
    friend drogon::orm::BaseBuilder<ExecutorsTasks, false, true>;
    friend drogon::orm::BaseBuilder<ExecutorsTasks, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<ExecutorsTasks>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where task_id = $1 and user_id = $2";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where task_id = $1 and user_id = $2";
        return sql;
    }
