 ...
 */
void Project::getCumulativeWorkingDayDelta(const HttpRequestPtr &req,
            std::function<void(const HttpResponsePtr &)> &&callback)
{
	LOG_DEBUG << "Project getCumulativeWorkingDayDelta called";
	...
	try
	{
        clientPtr->execSqlAsync(
            getProjectCompleteDateSql,
            [callback, projectId](const drogon::orm::Result &r) {
                Json::Value ret;
                ret["result"] = "ok";
