    ...
    std::function<void(const HttpResponsePtr &)> &&callback)
{
    try
    {
        ...
        std::string thisFriday = WeekTimeUtils::getThisFriday();
        
        LOG_DEBUG << "Filtering this week's tasks with thisMonday: " << thisMonday << " and thisFriday: " << thisFriday;
